...
export const ROUTES: RouteInfo[] = [
    // { path: '/dashboard', title: '1st Page',  icon: 'ni-tv-2 text-primary', class: '' },
    ...
    { path: '/maps', title: 'Working',  icon:'ni-pin-3 text-orange', class: '' },
    { path: '/tables', title: 'Working',  icon:'ni-bullet-list-67 text-red', class: '' },
